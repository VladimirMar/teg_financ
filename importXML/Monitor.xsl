			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 7.275cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="WIDTH: 2.857cm"/>
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>Curso_monitor</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>VCurso_monitor</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Tipo_de_vinculo</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Monitor">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Monitor', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('RG_monitor', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CPF_monitor', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Curso_monitor', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('VCurso_monitor', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Tipo_de_vinculo"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Nascimento', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Historico"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
