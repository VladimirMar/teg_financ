				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>VAL_CRMC</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Curso_condutor</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>VCurso_condutor</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Condutor">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Condutor', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CPF_condutor', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CRMC', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('VAL_CRMC', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Curso_condutor', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('VCurso_condutor', '', '', '', 7)"/>
								</td>
								<td>
