			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 3.809cm"/>
						<col style="WIDTH: 5.343cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="WIDTH: 2.38cm"/>
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>Cap_DETRAN</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Cap_TEG</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Cap_TEG_CRECHE</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Cap_ACESSIVEL</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>VAL_CRM</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Seguro_inicio</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Seguro_termino</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Tipo_de_bancada</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Tipo_de_veiculo</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Valor_veiculo</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>OS_especial</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Veiculo">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Placas', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Ano', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Cap_DETRAN', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Cap_TEG', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="Cap_TEG_CRECHE"/>
								</td>
								<td>
									<xsl:value-of select="Cap_ACESSIVEL"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('VAL_CRM', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Seguradora"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Seguro_inicio', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Seguro_termino', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Tipo_de_bancada"/>
								</td>
								<td>
									<xsl:value-of select="Tipo_de_veiculo"/>
								</td>
								<td>
									<xsl:value-of select="Marca_modelo"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Valor_veiculo', '&quot;R$&quot;#,##0.00;&quot;-R$&quot;#,##0.00', 'auto', '1046', 6)"/>
								</td>
								<td>
									<xsl:value-of select="OS_especial"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
